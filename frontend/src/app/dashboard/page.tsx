  ...
  if (!user && !loading) {
    return (
      <div className="text-center py-20 glass-panel rounded-2xl p-8 max-w-lg mx-auto">
        <div className="w-12 h-12 rounded-xl bg-indigo-600/20 text-indigo-400 flex items-center justify-center mx-auto mb-4">
        ...
        <button
          ...
          className="mt-6 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-lg shadow-indigo-500/25 transition-all"
        >
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="glass-panel rounded-2xl p-6 relative overflow-hidden border border-white/10 shadow-2xl">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-indigo-600 via-violet-600 to-sky-500 flex items-center justify-center text-white text-2xl font-black shadow-xl shadow-indigo-500/30 shrink-0">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="px-4 py-2.5 rounded-xl bg-slate-900/80 border border-white/5 text-center">
              <div className="text-lg font-bold text-indigo-400">{skillsCount}</div>
              <div className="text-[10px] text-slate-400 uppercase tracking-wider">Core Skills</div>
            </div>
            <div className="px-4 py-2.5 rounded-xl bg-slate-900/80 border border-white/5 text-center">
              <div className="text-lg font-bold text-violet-400">{projectsCount}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Column: Master Facts Explorer (4 cols) */}
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/builder"
              className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-sm transition-all"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Master Resume Card */}
            <div className="p-5 rounded-2xl glass-panel border border-indigo-500/30 relative overflow-hidden flex flex-col justify-between hover:border-indigo-500/50 transition-all group">
              <div>
                <div className="flex items-center justify-between">
              ...
              <div className="mt-5 pt-3 border-t border-white/5 flex items-center justify-between text-xs">
                ...
                <Link
                  href="/builder"
                  className="text-indigo-400 font-medium group-hover:text-indigo-300 flex items-center space-x-1"
                >
            ...
            <Link
              href="/builder"
              className="p-5 rounded-2xl border-2 border-dashed border-white/10 hover:border-indigo-500/40 hover:bg-indigo-500/5 transition-all flex flex-col items-center justify-center text-center group min-h-[160px]"
            >
              <div className="w-10 h-10 rounded-xl bg-indigo-600/10 text-indigo-400 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-all mb-2">
